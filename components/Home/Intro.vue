...
<template>
  <div class="space-y-6">
    ...
    <p class="text-gray-900 dark:text-gray-400" style="text-align: justify">
      I&apos;m Agus as software engineer based in Jakarta, Indonesia 🇮🇩. My
      interest in <b>software development</b>, <b>system design</b>,
      <b>cloud computing</b>, <b>machine learning</b>, and
      <b>internet of things</b>. Have ability to use some programming languages
      to build and maintenance application products then make sure it works.
    </p>
    <p class="text-gray-900 dark:text-gray-400" style="text-align: justify">
