...
export const commands: Command = [
  { cmd: "welcome", desc: "display first section", tab: 6 },
  { cmd: "who", desc: "all about me", tab: 10 },
  { cmd: "resume", desc: "view my resume", tab: 7 },
  { cmd: "education", desc: "education history", tab: 4 },
  { cmd: "experience", desc: "related experience", tab: 3 },

  { cmd: "blog", desc: "my some articles", tab: 9 },
  { cmd: "email", desc: "send an email to me", tab: 8 },
  { cmd: "projects", desc: "view projects that I've worked", tab: 5 },
  { cmd: "links", desc: "i have other links", tab: 8 },
